...
<html lang="en">
  <head>
    ...
    <title>Hiking Store - Adventure Outdoor</title>

    <!-- Google font -->
    <link href="<?php echo base_url() ?>assets/fonts/font-google.css" rel="stylesheet">
        ...
        <div id="responsive-nav">
          ...
          <ul class="main-nav nav navbar-nav">
            ...
            <li><a href="#">Accessories</a> -->
                    ...
                    <li><a href="<?php echo site_url('Member/create')?>">Register New Account</a></li>
          </ul>
          <!-- /NAV -->
        </div>
        <!-- /responsive-nav -->
